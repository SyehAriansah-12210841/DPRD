...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="{{(request()->is('profil/anggota')) ? 'text-secondary' : ''}}" href="{{route('all')}}">Anggota</a></li>
        </ol>
    </nav>
</div>
<div class="container my-5 px-5">
    ...
    <div class="row mx-2 g-2 justify-content-center">
        @forelse ($dapil->anggota as $anggota)
        <div class="col col-sm-6 col-md-4 col-lg-3">
            <a href="/profil/{{$anggota->id}}">
                <div class="card  d-flex border-0 " style="max-width: 200px">
